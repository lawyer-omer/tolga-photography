    ...
    <Box {...sectionWrapper} as="section" id="process_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading
            {...secTitle}
            content="Adım adım fotoğrafçı bulma rehberi :)"
          />
        </Box>
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            <Heading
              content="Öğrenmeyi ve modayı takip etmeyi hiç bırakmıyoruz !"
              {...learningTitle}
            />
            <Text
              content="Hem modaya uygun hem hiç eskimeyecek klasik çekimler."
              {...learningSubTitle}
            />
            <Text
              {...learningDescription}
              content="Bana göre öğrenmenin durması, görsel içerik üreticisinin üreticilikten çıkıp tekrarlayıcı olması demektir. Herzaman modayı takip etmek ve modaya uygun içeriklerin klasiklere yakışır, hiçbir zaman eskimeyecek içerikler oluşturmak için her gün yeni bir fikir için çalışıyorum."
            />
            <Text
              {...learningDescription}
              content="Modaya uygun, eskimeyecek çekimler için benimle tanışın."
            />
            <Box {...buttonWrapper}>
              <Text content="Merhaba?" {...buttonLabelStyle} />
              <ButtonWrapper>
                <Button
                  title="merhaba@tolga.photography"
