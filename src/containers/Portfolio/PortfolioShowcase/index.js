  ...
  return (
    <Box {...sectionWrapper} as="section" id="portfolio_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Heyecanınızı, yüksek bir enerji ile karşılıyorum !" />
          <Text
            {...secDescription}
            content="Fotoğrafçı ile uyum, 'olsa iyi olur' değil 'olmazsa olmaz'dır. Gerçek bir uyumun sırrı ise, kameranın her iki tarafının da aynı derecede heyecanlanmasından geçer. Sizin mutlu günlerinizde sizin kadar heyecanlanacak bir fotoğrafçıya ihtiyacınız var, ve merak etmeyin buldunuz :)"
          />
        </Box>
                      ...
                      <GlideSlide key={`PortfolioShowcaseItem-${index}`}>
                        <PortfolioShowcaseItem>
                          ...
                          <Box {...portfolioDetails}>
                            <PortfolioLink>
                              <Link href={portfolioItem.link || 'https://www.instagram.com/tolga.ocal06/'}>
                                <a>INSTAGRAM</a>
                              </Link>
                            </PortfolioLink>
                            <Heading
